...
# Task
Implementation: You have to implement the Secret Server API, with NodeJS + express.js framework on the backend (you can use any additonal library / database). It is recommended to store the data using encryption. 
